# CLASSES
class car:
    def __init__(self, maker, name, model, year, price) -> None:
        self.maker = maker
        self.name = name
        self.model = model
        self.year = year
...
car2 = car("BMW", "Competition", "M3", 20217, 30000000)
...
cnum = int(input(f"Enter car number: [1-{len(d1.inventory)}]"))
c1 = customer(cname)
...
print("\nAfter selling the available cars left")
